...
public interface IAnalyticsService
{
    ...
    List<DoctorDto> GetExperiencedDoctors(int minExperience);
    ...
    RepeatedAppointmentsAnalyticsDto GetRepeatedAppointments(int months);
    ...
    List<PatientAnalyticsDto> GetPatientsOlderThanWithMultipleDoctors(int age);
