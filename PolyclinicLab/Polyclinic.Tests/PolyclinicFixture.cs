...
public class PolyclinicFixture
{
    ...
    public PolyclinicFixture()
    {
        ...
        Doctors = new()
        {
            new() { Passport="D1", FullName="Dr. Alpha", BirthYear=1970, Specialization="Therapist", Experience=20 },
            new() { Passport="D2", FullName="Dr. Bravo", BirthYear=1975, Specialization="Cardiologist", Experience=15 },
            new() { Passport="D3", FullName="Dr. Charlie", BirthYear=1980, Specialization="Surgeon", Experience=12 },
        ...
        Patients = new()
        {
            new() { Passport="P1", FullName="Alice", Gender=Gender.Female, BirthDate=new(1985,1,3), Address="Addr1", BloodType=BloodType.A, RhFactor=RhFactor.Positive, Phone="+79613831297" },
            new() { Passport="P2", FullName="Bob", Gender=Gender.Male, BirthDate=new(1990,2,2), Address="Addr2", BloodType=BloodType.B, RhFactor=RhFactor.Negative, Phone="+79613831286" },
            new() { Passport="P3", FullName="Charlie", Gender=Gender.Male, BirthDate=new(1975,3,18), Address="Addr3", BloodType=BloodType.AB, RhFactor=RhFactor.Positive, Phone="+79613831211" },
            ...
            new() { Passport="P5", FullName="Eve", Gender=Gender.Female, BirthDate=new(1982,5,6), Address="Addr5", BloodType=BloodType.B, RhFactor=RhFactor.Positive, Phone="+79613831214" },
            ...
            new() { Passport="P8", FullName="Henry", Gender=Gender.Male, BirthDate=new(1988,8,15), Address="Addr8", BloodType=BloodType.AB, RhFactor=RhFactor.Negative, Phone="+79613831217" },
            ...
            new() { Passport="P10", FullName="Jack", Gender=Gender.Male, BirthDate=new(1970,10,23), Address="Addr10", BloodType=BloodType.A, RhFactor=RhFactor.Negative, Phone="+79613831219" }
        };
